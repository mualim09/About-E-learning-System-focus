	...
	if(isset($_POST['desc'])){
	 ...
	 //updating the question and type into table question
		mysqli_query($conn," UPDATE questions 
				...
				WHERE question_id='$q_id' ")or die(mysqli_error());

	 //deleting the answers
		mysqli_query($conn,"DELETE FROM answers WHERE question_id='$q_id'")or die(mysqli_error());
		...
		if($type == 'tf'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer1', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer2', '0')")or die(mysqli_error());
		 ...
		 //if answer2 is marked correct, do this--
			if($isCorrect == "answer2"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer2', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer1', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$q_id.' has been edited';
				header('location: admin.php?msg='.$msg.'');
				exit();
			}	
		...
		if($type == 'mc'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer1', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer3', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer4', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$q_id.' has been edited';
			  	header('location: admin.php?msg='.$msg.'');
				exit();
			}
		 ...
		 //if answer3 is marked correct, do this--
			if($isCorrect == "answer3"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer3', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer1', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer4', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$q_id.' has been edited';
		 ...
		 //if answer4 is marked correct, do this--
			if($isCorrect == "answer4"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer4', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer1', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$q_id', '$answer3', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$q_id.' has been edited';
