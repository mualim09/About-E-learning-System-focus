 ...
 //checking if the required data has been filled
	if(isset($_POST['desc'])){
	 ...
	 //getting and converting strings as they are
		...
		$answer4 = mysqli_real_escape_string($conn,$answer4);
	 ...
	 //inserting the question and type into table question
		$sql = mysqli_query($conn,"INSERT INTO questions (quiz_id, question, code, code_type, type) VALUES ('$quizID', '$question', '$program', '$programType', '$type')")or die(mysqli_error());
		//lastId is there, so we can insert the id, question_id in our table
			$lastId = mysqli_insert_id($conn);
			mysqli_query($conn,"UPDATE questions SET question_id='$lastId' WHERE id='$lastId' LIMIT 1")or die(mysqli_error());

	 ///////Updating value of total questions in quizes
		mysqli_query($conn,"UPDATE quizes SET total_questions=total_questions+1 WHERE quiz_id='$quizID' LIMIT 1")or die(mysqli_error());
		...
		if($type == 'tf'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysqli_error());
		 ...
		 //if answer2 is marked correct, do this--
			if($isCorrect == "answer2"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '1')")or die(mysqli_error());
				mysqli_query("INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
				header('location: admin.php?msg='.$msg.'');
				exit();
			}	
		...
		if($type == 'mc'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
			  	header('location: admin.php?msg='.$msg.'');
				exit();
			}
		 //if answer2 is marked correct, do this--
			if($isCorrect == "answer2"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		  		header('location: admin.php?msg='.$msg.'');
		 ...
		 //if answer3 is marked correct, do this--
			if($isCorrect == "answer3"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		 ...
		 //if answer4 is marked correct, do this--
			if($isCorrect == "answer4"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '1')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysqli_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '0')")or die(mysqli_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
...
//if resetTables is clicked
	if(isset($_POST['resetTables']) && $_POST['resetTables'] != ""){
		...
		if($resetT=='yes'){
			mysqli_query($conn,"TRUNCATE TABLE admins")or die(mysqli_error());
			mysqli_query($conn,"TRUNCATE TABLE answers")or die(mysqli_error());
			mysqli_query($conn,"TRUNCATE TABLE questions")or die(mysqli_error());
			mysqli_query($conn,"TRUNCATE TABLE quizes")or die(mysqli_error());
			mysqli_query($conn,"TRUNCATE TABLE quiz_takers")or die(mysqli_error());
...
//When editaquestion is clicked
	...
	if(isset($_POST['editaquestion']) && $_POST['editaquestion'] != ""){
		...
		$get_quiz_id_SQL = mysqli_query($conn,"SELECT quiz_id FROM quizes 
		...
		if($editQ=='allthequestions')
			$multipleSQL = mysqli_query($conn,"SELECT * FROM questions") or die(mysqli_error());
		else
			$multipleSQL = mysqli_query($conn,"SELECT * FROM questions WHERE quiz_id = '$get_quiz_id'");
			...
			while($m_row = mysqli_fetch_array($multipleSQL)){
			 ...
			 //id var = id column and so on
				...
				$m_quiz_id_SQL = mysqli_query($conn,"SELECT quiz_name FROM quizes 
			 ...
			 //gathering answers of question here
				$m_sql2 = mysqli_query($conn,"SELECT * FROM answers WHERE question_id='$m_question_id'") or die(mysqli_error());
...
//When editAQ is clicked
	...
	if(isset($_POST['editAQ']) && $_POST['editAQ'] != ""){
	 ...
	 //getting everything about the question
		$getaquestion_SQL = mysqli_query($conn,"SELECT * FROM questions 
	 ...
	 //converting program into what it ought to be
		...
		$gaq_code_editor = mysqli_real_escape_string($conn,$gaq_code_editor);
		$gaq_code_editor = str_replace(array("\r\n", "\r", "\n"), '\n', $gaq_code_editor);



		$getanswers_SQL = mysqli_query($conn,"SELECT * FROM answers 
						WHERE question_id='$editAQ'")or die(mysqli_error());
	 ...
	 //if the question is multiple choice!
			...
			while($getanswers_row = mysqli_fetch_array($getanswers_SQL)){
				$ga_answer = $getanswers_row['answer'];
				$ga_correct = $getanswers_row['correct'];
				$ga_answer = mysqli_real_escape_string($conn,$ga_answer);
...
//if deleteAdmin is clicked, check--
	if(isset($_POST['deleteAdmin']) && $_POST['deleteAdmin'] != ""){
		...
		mysqli_query($conn,"DELETE FROM admins WHERE username = '$deleteA'")or die(mysqli_error());

	//checking the admins table
		$admin_SQL = mysqli_query($conn,"SELECT id FROM admins 
...
//if defaultQuiz is clicked, check--
	if(isset($_POST['defaultQuiz']) && $_POST['defaultQuiz'] != ""){
	 ...
	 ///////Updating value of set_default in quizes
		mysqli_query($conn,"UPDATE quizes SET set_default=0 WHERE set_default=1")or die(mysqli_error());
		mysqli_query($conn,"UPDATE quizes SET set_default=1 WHERE quiz_name='$defaultQ'")or die(mysqli_error());


 //checking if update is successful
	//getting rows from tables
		$defaultQ_sql1 = mysqli_query($conn,"SELECT id FROM quizes WHERE set_default=1")or die(mysqli_error());
...
//if clearResult is clicked, check--
	...
	//deleting
		mysqli_query($conn,"DELETE FROM quiz_takers WHERE quiz_id='$clearR'")or die(mysqli_error());



 //checking if delete is successful
	//getting rows from tables
		$QuizTakersSQL = mysqli_query($conn,"SELECT id FROM quiz_takers WHERE quiz_id='$clearR' LIMIT 1")or die(mysqli_error());
	//getting number of rows that were returned
...
//if reset is clicked, check--
	...
	//resetting the tables
	 ...
	 ///////Updating value of total questions in quizes
		mysqli_query($conn,"UPDATE quizes SET total_questions=0")or die(mysqli_error());


 //checking if truncate is successful
	//getting rows from tables
		$sql1 = mysqli_query($conn,"SELECT id FROM questions LIMIT 1")or die(mysqli_error());
		$sql2 = mysqli_query($conn,"SELECT id FROM answers LIMIT 1")or die(mysqli_error());
	//getting number of rows that were returned
...
//if deleteQuiz is clicked, check--
	...
	//resetting the tables
		$qz_id_SQL = mysqli_query($conn,"SELECT quiz_id FROM quizes 
									WHERE quiz_name = '$deleteQ'")or die(mysqli_error());
		$qz_id_SQL_row = mysqli_fetch_array($qz_id_SQL);
        $qz_id = $qz_id_SQL_row['quiz_id'];

		mysqli_query($conn,"DELETE FROM quizes WHERE quiz_id = '$qz_id'")or die(mysqli_error());
		mysqli_query($conn,"DELETE FROM questions WHERE quiz_id = '$qz_id'")or die(mysqli_error());
		mysqli_query($conn,"DELETE FROM answers WHERE quiz_id = '$qz_id'")or die(mysqli_error());

 //checking if delete is successful
	//getting rows from tables
		$qz_sql1 = mysqli_query($conn,"SELECT id FROM questions WHERE quiz_id = '$qz_id' LIMIT 1")or die(mysqli_error());
		$qz_sql2 = mysqli_query($conn,"SELECT id FROM answers WHERE quiz_id = '$qz_id' LIMIT 1")or die(mysqli_error());
		$qz_sql3 = mysqli_query($conn,"SELECT id FROM quizes WHERE quiz_id = '$qz_id' LIMIT 1")or die(mysqli_error());
...
//php to get everything for menu quiz Management!
	...
	$quizIdSQL = mysqli_query($conn,"SELECT quiz_id, quiz_name, display_questions, time_allotted FROM quizes") or die(mysqli_error());
...
//PHP for showing Top 20 Users
	...
	if(isset($_POST['usersQuiz']) && $_POST['usersQuiz'] != ""){
		...
		$multipleSQL = mysqli_query($conn,"SELECT * FROM quiz_takers 
