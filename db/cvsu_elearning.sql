...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2019 at 08:43 PM
...
(18, 4, '20190349', '13123123', 'asdasdasd', 2, NULL),
(19, 4, '20190350', '13123123', 'asdasdasd', 2, NULL),
(20, 4, '20190351', 'Programming 32', 'asdwqeyutqweqwe', 2, NULL),
(21, 4, '20190352', 'asdasd', '23123', 2, NULL),
(23, 6, '20190354', 'Javascript', 'java32', 1, NULL),
(25, 6, '20190429', 'Programming 32', 'asdasda', 1, NULL);
...
(10, 6, 23, NULL, 'Post1', '<p>java</p>\r\n', '2019-07-29 22:04:24'),
(11, 6, 23, NULL, 'Walang Pasok', '<p>asdasdasd</p>\r\n', '2019-07-29 22:04:29'),
(13, 6, 23, NULL, 'Neww', '<p>neww</p>\r\n', '2019-07-29 22:21:58');
...
(1, NULL, 'Quiz 1', '2019-08-20 16:38:57', '2019-08-17 16:00:00', '10', 1, 1),
(2, NULL, 'Quiz 2', '2019-08-20 16:38:58', '2019-08-17 16:00:00', '10', 1, 1),
(3, NULL, 'Quiz 3', '2019-08-20 16:38:59', '2019-08-17 16:00:00', '10', 1, 1),
(4, NULL, 'Quiz 4', '2019-08-20 16:39:00', '2019-08-17 16:00:00', '10', 2, 1);
...
--
-- Dumping data for table `class_room_test_attemp`
--

INSERT INTO `class_room_test_attemp` (`atmp_ID`, `user_ID`, `test_ID`, `count`) VALUES
(2, 7, 1, 2);
...
--
-- Dumping data for table `class_room_test_score`
--

INSERT INTO `class_room_test_score` (`score_ID`, `test_ID`, `score`, `user_ID`) VALUES
(1, 1, 0, 7);
...
--
-- Dumping data for table `class_room_topic`
--

INSERT INTO `class_room_topic` (`classTopic_ID`, `class_ID`, `classTopic_Name`) VALUES
(4, 23, 'java'),
(5, 23, 'C++');
...
INSERT INTO `record_admin_details` (`rad_ID`, `rad_Img`, `user_ID`, `rad_EmpID`, `rad_FName`, `rad_MName`, `rad_LName`, `suffix_ID`, `rad_Sex`, `rad_Email`, `rad_Bday`, `rad_Address`) VALUES
(1, NULL, 1, '123548', 'admin', 'admin', 'admin', 1, 1, '321@gmail.com', NULL, NULL);
...
INSERT INTO `record_instructor_details` (`rid_ID`, `rid_Img`, `user_ID`, `rid_EmpID`, `rid_FName`, `rid_MName`, `rid_LName`, `suffix_ID`, `sex_ID`, `rid_Email`, `rid_Bday`, `rid_Address`) VALUES
(1, NULL, NULL, '30203012', 'Constancia', 'L', 'Casil', 1, 1, NULL, NULL, NULL),
(3, NULL, 2, '30203013', 'Junior', 'C', 'Paor', 1, 2, 'instructor@gmail.com', NULL, NULL),
(4, NULL, NULL, '30203014', 'Heimer', 'D', 'Constantine', 2, 1, NULL, NULL, NULL),
(5, NULL, NULL, '30203015', 'Tris', 'M', 'Ace', 1, 1, NULL, NULL, NULL);
...
INSERT INTO `record_student_details` (`rsd_ID`, `rsd_Img`, `user_ID`, `rsd_StudNum`, `rsd_FName`, `rsd_MName`, `rsd_LName`, `suffix_ID`, `sex_ID`, `rsd_Email`, `course_ID`, `rsd_Bday`, `rsd_Address`) VALUES
(1, NULL, NULL, '201910656', 'Darwin', 'N', 'Villanueva', 1, 1, NULL, 1, '2019-09-09', NULL),
(2, NULL, NULL, '201910657', 'Hero', 'M', 'Paor', 1, 1, NULL, 1, NULL, NULL),
(5, NULL, NULL, '201910658', 'Hawk', 'W', 'Demiurge', 1, 1, NULL, 1, NULL, NULL),
(7, NULL, 4, '201910659', 'Shin', 'C', 'Zhen', 2, 1, 'test@gmail.com', 1, NULL, NULL);
...
--
ALTER TABLE `class_room`
  MODIFY `class_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `class_room_post`
  MODIFY `classPost_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
