        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-bg-green">
               ...
               <div class="col-sm-12 sql_simulator">
                ...
                <?php
                $host = 'http://sqlfiddle.com/';
                if($socket =@ fsockopen($host, 80, $errno, $errstr, 30)) {
                $sqlsm = "http://sqlfiddle.com/";
                fclose($socket);
                } else {
                $sqlsm = " https://dbfiddle.uk/";
                }
                ?>
                <iframe src="<?php echo $sqlsm?>" style=" display:block;width:100%; height: 650px;"  frameBorder="0" ></iframe>
               </div>
